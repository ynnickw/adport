...
Then run `claude plugin validate ./plugins/adport` before publishing. Third-party public submissions go through Anthropic's reviewed `claude-community` marketplace.
